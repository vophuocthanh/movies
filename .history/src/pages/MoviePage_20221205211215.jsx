...
const MoviePage = () => {
  ...
  useEffect(() => {
    if (filterDebounce) {
      setUrl(
        "https://api.themoviedb.org/3/search/movie?api_key=55e25eecd2352fcad30e9d1c0a5aa854"
      );
    } else {
      setUrl(
        `https://api.themoviedb.org/3/movie/popular?api_key=55e25eecd2352fcad30e9d1c0a5aa854&query=${filterDebounce}`
      );
    }
  }, [filterDebounce]);
